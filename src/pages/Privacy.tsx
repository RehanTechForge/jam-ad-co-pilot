        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="p-6 mb-8 bg-card/50">
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li>• We collect your account info, Shopify store data, and ad performance metrics to provide our service</li>
              <li>• Your data is encrypted and stored securely; we never sell personal information</li>
              <li>• We share data with platforms you connect (Shopify, Meta, TikTok) to manage your ads</li>
              <li>• You can request to access, correct, or delete your data at any time</li>
              <li>• We use cookies for authentication and improving your experience</li>
            </ul>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <Card className="p-4 hover:border-primary transition-colors cursor-pointer">
              ...
              <p className="text-xs text-muted-foreground">Email: [CONTACT_EMAIL]</p>
            </Card>
            <Card className="p-4 hover:border-primary transition-colors cursor-pointer">
              <Shield className="h-5 w-5 text-primary mb-2" />
              <h3 className="font-semibold text-sm mb-1">Delete Your Account</h3>
              <p className="text-xs text-muted-foreground">Settings → Account → Delete</p>
            </Card>
            <Card className="p-4 hover:border-primary transition-colors cursor-pointer">
          ...
          <ScrollArea className="h-[600px] rounded-lg border p-6 bg-card">
            <div className="prose prose-sm max-w-none dark:prose-invert">
              ...
              <p>
                [COMPANY_NAME] ("we", "us", "our") operates JAM, a marketing automation platform for Shopify 
                merchants. This Privacy Policy explains how we collect, use, disclose, and safeguard your 
              ...
              <ul>
                <li><strong>Account Information:</strong> Full name, email address, company name, password (encrypted)</li>
                <li><strong>Waitlist Data:</strong> Name and email for early access requests</li>
                <li><strong>Shopify Store Data:</strong> Store URL, admin API credentials, business details</li>
                <li><strong>Payment Information:</strong> Processed securely through third-party providers (we don't store card numbers)</li>
                <li><strong>Support Communications:</strong> Messages, emails, and feedback you send us</li>
              </ul>
              ...
              <ul>
                <li>Product catalog (names, descriptions, prices, images, SKUs, inventory levels)</li>
                <li>Order data (order IDs, amounts, timestamps, customer locations - anonymized)</li>
                <li>Store analytics (traffic, conversion rates, cart data)</li>
                <li>Customer segments and tags (without personal customer data)</li>
              </ul>

              <h4>Meta (Facebook/Instagram) Integration:</h4>
              <ul>
                <li>Ad account ID and access tokens</li>
                <li>Campaign performance metrics (impressions, clicks, CTR, ROAS, spend)</li>
                <li>Audience insights (demographics, interests - aggregated only)</li>
              ...
              <ul>
                <li>Creator profiles (portfolios, rates, styles, contact info)</li>
              ...
              <ul>
                <li><strong>Usage Data:</strong> Features used, clicks, page views, session duration</li>
                <li><strong>Device Information:</strong> IP address, browser type, operating system, device type</li>
                <li><strong>Cookies:</strong> Session cookies, authentication tokens, preference settings</li>
                <li><strong>Log Data:</strong> Access times, error logs, API calls</li>
                <li><strong>Analytics:</strong> Aggregated usage patterns, feature adoption, performance metrics</li>
              </ul>
              ...
              <ul>
                <li>Create and manage your JAM account</li>
                <li>Generate AI-powered advertisements using your product data</li>
                ...
                <li>Provide the AI Performance Coach with context for recommendations</li>
              ...
              <ul>
                <li><strong>Contract Performance:</strong> To provide the services you've subscribed to</li>
              ...
              <ul>
                <li><strong>Cloud Hosting:</strong> [Cloud provider placeholder] for data storage</li>
                <li><strong>Payment Processing:</strong> Stripe/Shopify Billing for subscriptions</li>
                <li><strong>Email Services:</strong> For transactional and marketing emails</li>
                <li><strong>Analytics:</strong> Aggregated usage tracking</li>
                <li><strong>AI Providers:</strong> OpenAI for content generation (no personal data shared)</li>
              </ul>

              <h3>4.2 Integration Partners</h3>
              <p>When you connect accounts, we share necessary data with:</p>
              <ul>
                <li><strong>Shopify:</strong> To sync your store data and process webhooks</li>
                <li><strong>Meta:</strong> Ad content, targeting parameters, campaign settings</li>
                <li><strong>TikTok:</strong> Creative assets, campaign configurations</li>
              </ul>
              <p className="font-semibold">
                Important: We use OAuth tokens to act on your behalf. We never share your passwords.
              </p>
              ...
              <ul>
                ...
                <li>Share individual user data with other JAM users</li>
              ...
              <p>
                Data is stored on servers hosted by [Cloud Provider] in [Region]. We use Content Delivery 
                Networks (CDNs) for static assets globally.
              </p>
              ...
              <ul>
                ...
                <li><strong>Logs:</strong> Security logs retained for 12 months</li>
                <li><strong>Analytics:</strong> Aggregated data may be retained indefinitely</li>
                <li><strong>Legal Holds:</strong> Data preserved as required by law</li>
              </ul>

              <h3>5.4 International Transfers</h3>
              <p>
                If you're outside [Country], your data may be transferred internationally. We ensure 
              ...
              <div className="bg-muted/50 p-4 rounded-lg">
                <p><strong>Request Data Export:</strong></p>
                <ol>
                  <li>Go to Settings → Privacy → Export Data</li>
                  <li>Or email [CONTACT_EMAIL] with subject "Data Export Request"</li>
                </ol>
                
                <p className="mt-4"><strong>Delete Your Account:</strong></p>
                <ol>
                  <li>Go to Settings → Account → Delete Account</li>
                  <li>Or email [CONTACT_EMAIL] with subject "Account Deletion Request"</li>
                </ol>
                
                <p className="mt-4"><strong>Revoke Integration Access:</strong></p>
                <ol>
              ...
              <ul>
                ...
                <li>Email [CONTACT_EMAIL] to opt-out</li>
              </ul>
              ...
              <p>
                You can manage cookies through browser settings or our cookie preference center. 
              ...
              <p>JAM uses artificial intelligence for:</p>
              <ul>
                <li><strong>Ad Generation:</strong> Creating ad copy, images, and videos based on your products</li>
                <li><strong>Campaign Optimization:</strong> Adjusting bids and budgets based on performance</li>
                <li><strong>Trend Matching:</strong> Suggesting ad formats based on market trends</li>
                <li><strong>Performance Coaching:</strong> Providing recommendations via the AI assistant</li>
              </ul>

              <h3>8.2 Human Override</h3>
              <p>
                All automated decisions can be reviewed and overridden. You maintain full control over 
                campaign launches and budget changes. Contact [CONTACT_EMAIL] to opt-out of specific 
                automated features.
              </p>

              <h2 id="children">9. Children's Privacy</h2>
              <p>
                JAM is not intended for users under 16 years old. We do not knowingly collect data from 
                children. If we discover a user is under 16, we will delete their account and data 
                immediately. Report underage users to [CONTACT_EMAIL].
              </p>
              ...
              <p>
                To exercise CCPA rights, email [CONTACT_EMAIL] with subject "CCPA Request" or call [Phone].
              </p>
              ...
              <p>
                Review the "Last Updated" date above. Continued use after changes constitutes acceptance.
              </p>
            ...
            <Tabs defaultValue="general" className="w-full">
              ...
              <TabsContent value="general" className="mt-4">
                <p className="text-sm text-muted-foreground">
                  This privacy policy applies to all users globally. Some regions have additional rights 
                  outlined in the specific tabs.
                </p>
              </TabsContent>
              ...
              <TabsContent value="california" className="mt-4">
                <div className="space-y-2 text-sm">
                  <p className="font-semibold">California Consumer Privacy Act:</p>
                  <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
          ...
          <Alert className="mt-8 border-warning">
            <AlertDescription className="font-semibold">
              ...
              Consult a licensed attorney to finalize and localize this privacy policy for your specific business needs and jurisdiction.
            </AlertDescription>
          </Alert>
