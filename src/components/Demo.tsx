...
const Demo = () => {
  ...
  // Array of products with associated videos
  const products = [
    { name: "Athletic Shoes", price: "$29.99", img: genericShoes, video: v2 },
    { name: "Headphones", price: "$59.99", img: genericHeadphones, video: v1 },
    { name: "Backpack", price: "$39.99", img: genericBackpack, video: v3 },
    { name: "Watch", price: "$79.99", img: genericWatch, video: v4 },
  ];
  ...
  // Handle product click to set selected product and video
                    ...
                    <div>
                      ...
                      <div className="bg-popover rounded-xl p-6 border border-border">
                        <div className="aspect-video bg-black rounded-lg mb-4 overflow-hidden relative">
                          <video
                            src={products[selectedProduct].video}
                            autoPlay={isPlaying}
                            loop
                            muted
