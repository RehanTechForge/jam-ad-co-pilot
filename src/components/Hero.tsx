        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-up">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              JAIM connects to your Shopify store, auto-generates image & video
              creatives, and manages campaigns across Meta & TikTok — so you can
              sell more without the marketing complexity.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button
                onClick={onScheduleDemo || onOpenWaitlist}
                size="lg"
          ...
          >
            ...
            <div
              className="absolute -bottom-4 -left-4 bg-card rounded-xl p-4 shadow-lg border border-border animate-float"
