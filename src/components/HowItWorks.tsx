...
const steps = [
  {
    ...
    description: 'One-click integration with your store and Meta/TikTok accounts. Secure OAuth, no passwords needed.',
  ...
  },
  {
    ...
    description: 'Select products to promote and your growth strategy. JAM handles the creative work.',
    features: ['AI creative generation', 'Trend matching', 'Audience targeting']
  },
  {
    number: '03',
    icon: Rocket,
    title: 'Launch or schedule',
    description: 'Review, launch immediately, or schedule campaigns. Sit back while JAM optimizes performance.',
    features: ['Auto-optimization', 'Budget management', 'Performance tracking']
  }
];

const HowItWorks = () => {
  return (
    <section id="how-it-works" className="py-20 relative bg-gradient-to-b from-background to-card/30">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 animate-on-scroll">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            No marketing experience needed. JAM handles the complexity so you can focus on your business.
          </p>
        </div>
